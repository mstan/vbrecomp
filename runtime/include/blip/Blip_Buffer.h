...
/* vbrecomp vendoring: Mednafen's build passes -DINLINE="inline"; provide a
 * fallback so this header compiles standalone in the runtime. (Only
 * adaptation vs the upstream file at beetle-vb/mednafen/include/blip/.) */
#ifndef INLINE
